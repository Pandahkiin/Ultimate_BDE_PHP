<div>
    ...
    <p>Les conditions générales de vente décrites ci-après détaillent les droits et obligations du BDE du CESI et de son client dans le cadre de la vente des marchandises suivantes : goodies à l'effigie du BDE.</p>
    <p>Toute prestation accomplie par le BDE du CESI implique donc l'adhésion sans réserve de l'acheteur aux présentes conditions générales de vente.</p>
    ...
    <p>Le BDE du CESI s'accorde le droit de modifier ses tarifs à tout moment. Toutefois, elle s'engage à facturer les marchandises commandées aux prix indiqués lors de l'enregistrement de la commande.</p>

    <h2>Clause n° 3 : Rabais et ristournes</h2>
    <p>Les tarifs proposés comprennent les rabais et ristournes que le BDE du CESI serait amenée à octroyer compte tenu de ses résultats ou de la prise en charge par l'acheteur de certaines prestations.</p>
    ...
    <p>En cas de défaut de paiement total ou partiel des marchandises livrées au jour de la réception, l'acheteur doit verser au BDE du CESI une pénalité de retard égale à trois fois le taux de l'intérêt légal.</p>
    ...
    <p>Si dans les quinze jours qui suivent la mise en oeuvre de la clause " Retard de paiement ", l'acheteur ne s'est pas acquitté des sommes restant dues, la vente sera résolue de plein droit et pourra ouvrir droit à l'allocation de dommages et intérêts au profit du BDE du CESI.</p>

    <h2>Clause n° 8 : Clause de réserve de propriété</h2>
    <p>Le BDE du CESI conserve la propriété des biens vendus jusqu'au paiement intégral du prix, en principal et en accessoires. À ce titre, si l'acheteur fait l'objet d'un redressement ou d'une liquidation judiciaire, le BDE du CESI se réserve le droit de revendiquer, dans le cadre de la procédure collective, les marchandises vendues et restées impayées.</p>

    <h2>Clause n° 9 : Livraison</h2>

    <p>La livraison est effectuée par remise directe de la marchandise avec l'acheteur.</p>
    ...
    <p>À défaut de résolution amiable, le litige sera porté devant un Tribunal de commerce.</p>
    
    Fait à Lingolsheim , le 28/01/2019.
</div>